      ...
      <div className="container">
        <div className="row">
          <div className="col-md-8 mx-auto mt-4">
            ...
            <input type="text" placeholder="GG/AA/YYYY"  className="form-control" onChange={(e)=>setTarih(e.target.value)}/>
            <table className="table table-striped table-dark table-hover">
              ...
              <tbody>
                <tr className='text-white'className={veri===undefined? "table-danger" : "table-success"} >
                  <th scope="row">{veri===undefined? "Veri Bekleniyor" : veri.date}</th>
                  <td >{veri===undefined? "Veri Bekleniyor" : veri.tests}
            </td>
